...
cp configuration/helloworld-vagrant/helloworld.manifest docker/sdx_container/
cp configuration/helloworld-vagrant/helloworld.manifest docker/lc_container/
