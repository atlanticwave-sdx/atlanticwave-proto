...
class SDXController(AtlanticWaveModule):
    ...
    def _handle_new_connection(self, cxn):
        ...
        for switch in topo.node[name]['switches']:
            print "-----------CW--------SDXController: for switch in topo.node[name]['switches']:------------"
            print switch
            json_rule = {"EdgePort":{"switch":switch}}
            epp = EdgePortPolicy(AUTOGENERATED_USERNAME, json_rule)
            #json_rule = {"ManagementSDXRecover":{"switch":switch}}
            #msr = ManagementSDXRecoverPolicy(AUTOGENERATED_USERNAME, json_rule)
            #print "-----------CW--------SDXController:ManagementSDXRecoverPolicy(AUTOGENERATED_USERNAME, json_rule)-------"
            #print json_rule
    ...
    def _handle_connection_loss(self, cxn):
        ...
        # Get LC name
        name = cxn.get_name()
        print "------------CW-----------SDXController: _handle_connection_loss(self, cxn):name = cxn.get_name()-------"
        print name
        ...
        topo = self.tm.get_topology()
        print "------------CW-----------internalconfig----------"
        backuplc = topo.node[name]['internalconfig']['backuplc']
        ...
        json_rule = {"ManagementSDXRecover":{"switch":backuplc}}
        msr = ManagementSDXRecoverPolicy(AUTOGENERATED_USERNAME, json_rule) 
        self.rm.add_rule(msr)
        pass
