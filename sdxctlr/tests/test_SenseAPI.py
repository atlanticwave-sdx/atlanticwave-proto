...
DB_FILE = ":memory:"
BASIC_MANIFEST_FILE = "tests/senseapi_files/twoswitch-onelc-noncorsa.manifest"
...
class DeltaTest(unittest.TestCase):
    ...
    def test_parse_addition(self):
        ...
        addition_filename = "tests/senseapi_files/addition_10.txt"
    ...
    def test_parse_delta_reduction(self):
        ...
        reduction_filename = "tests/senseapi_files/reduction_10.txt"
    ...
    def atest_parse_delta_addition_l2multipoint(self):
        ...
        addition_filename = "tests/senseapi_files/addition_2.txt"
        with open(addition_filename, 'r') as addition_file:
            addition = addition_file.read()
    ...
    def atest_process_delta_reduction_nonexistant(self):
        ...
        full_delta_filename = "tests/senseapi_files/delta_red_1.txt"
    ...
    def atest_process_delta_addition(self):
        ...
        full_delta_filename = "tests/senseapi_files/delta_add_1.txt"
        with open(full_delta_filename, 'r') as delta_file:
            deltadata = eval(delta_file.read())
        # Install rule
        delta_id = "ad6d9b50-8beb-48aa-8523-9303c075e942"
    ...
    def atest_bad_process_reduction_decode(self):
        ...
        full_delta_filename = "tests/senseapi_files/delta_red_bad_1.txt"
        with open(full_delta_filename, 'r') as delta_file:
            deltadata = eval(delta_file.read())
    ...
    def atest_bad_process_addition_decode(self):
        ...
        full_delta_filename = "tests/senseapi_files/delta_add_bad_1.txt"
        with open(full_delta_filename, 'r') as delta_file:
            deltadata = eval(delta_file.read())
    ...
    def atest_bad_process_reduction_invalid_reduction(self):
        ...
        full_delta_filename = "tests/senseapi_files/delta_red_bad_2.txt"
        with open(full_delta_filename, 'r') as delta_file:
            deltadata = eval(delta_file.read())
    ...
    def atest_bad_process_addition_invalid_addition(self):
        ...
        full_delta_filename = "tests/senseapi_files/delta_add_bad_2.txt"
        with open(full_delta_filename, 'r') as delta_file:
            deltadata = eval(delta_file.read())
