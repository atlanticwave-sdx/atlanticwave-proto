...
from sdxctlr.BreakdownEngine import BreakdownEngine
from sdxctlr.ValidityInspector import ValidityInspector
...
class RuleManager(AtlanticWaveManager):
    ...
    def remove_all_rules(self, user):
        ...
        for rule in self.rule_table.find():
            parsed_rule = pickle.loads(rule['rule'])
